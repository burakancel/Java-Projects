public class Student {
    ...
    void printNote(){
        ...
        System.out.println(this.c1.name+"Sozlu\t"+this.c1.sozlu);
        System.out.println(this.c2.name+"Sozlu\t"+this.c2.sozlu);
        System.out.println(this.c3.name+"Sozlu\t"+this.c3.sozlu);
